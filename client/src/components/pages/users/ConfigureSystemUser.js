                  ...
                  <div className='card'>
                    <div className='card-header'>
                      <h3 className='form-section'>
                        {`${'Đã hoàn tất thiết lập tài khoản mới cho '} ${
                          this.state.fullname
                        } ${','} ${this.state.jobTitle}`}
                      </h3>
                    </div>
                    ...
                    <div className='card-body'>
                      <form action='/upload' method='POST'>
                        ...
                        <dl className='row ml-2 mb-2'>
                          <dt className='col-sm-3'>Tên Đăng Nhập:</dt>
                        ...
                        {/* </div> */}
                        <dl className='row ml-2 mb-2'>
                          <dt className='col-sm-3'>Mã nhân viên:</dt>
                        ...
                        <div className='row ml-2'>
                          <p>
                            Đây là mật khẩu tạm thời dành cho{' '}
                            <strong>{`${this.state.fullname}`}</strong>. Đưa
                            thông tin đăng nhập này đến{' '}
                            <strong>{`${this.state.fullname}`}</strong> để họ có
                            thể đăng nhập vào hệ thống. Lần đầu tiên đăng nhập
                            vào hệ thống,{' '}
                            <strong>{`${this.state.fullname}`}</strong> sẽ phải
                            thay đổi mật khẩu.
                          </p>
                        </div>
                        ...
                        <div className='form-actions top'>
                          ...
                          >
                            <i className='ft-chevron-down' /> Hoàn Tất
                          </Link>
                        </div>
                      </form>
                    </div>
